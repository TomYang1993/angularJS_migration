# AngularJS Phone Catalog Application & migration from AngularJS to Angular


## Overview

The application is loosely based on the **Google Phone Gallery**, which no longer exists.
Here is a historical reference: [Google Phone Gallery on WayBack][google-phone-gallery]

The main purpose is to migrate AngularJS to Angular on a trial.
...
app/                     --> all the source code of the app (along with unit tests)
  ...
  app.module.ajs.js          --> the main app module
